...
class ind3612Controller extends BaseController {
...
/*		$sql_uni="Select en.*, pro.nombre as programa, ind.nombre as indicadores 
	...
	public function guardar($arrainput){
		...
		if($arrainput['tipo']!="eliminar"){
			...
			$campos="programa_fk=$programa, indicador_fk=$indicador, c1='$c1', c2=$c2, c3=$c3, c5='$c5', estado_fk=$estado";
		...
		if($arrainput['codigo_id']=="" ||$arrainput['codigo_id']=="-1"){
			...
			$result=DB::insert("insert into ind3612 set $campos");
			
		}else{
			// modificar o eliminar 
			
			$result=DB::update("update ind3612 set $campos where codigo=".$arrainput['codigo_id']);
