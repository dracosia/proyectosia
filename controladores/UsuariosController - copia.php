...
class UsuariosController extends BaseController {
	...
	*/
	...
	public function buscar($arrainput)
	{
		...
		$sql_uni="Select fa.*, mo.nombre as sede, lo.nombre as empresa, ko.nombre as perfil 
				 from usuarios fa 
	...
	public function guardar($arrainput){
		...
		if($arrainput['tipo']!="eliminar"){
			...
			if($arrainput['password']==""){
				return Response::json(array("status"=>'error',"mensaje"=>'El Password es obligatorio'));
			}	
			...
			$campos="codigo='$codigo', cod_universidad='$cod_universidad', identificacion='$identificacion', nombre='$nombre', apellidos='$apellidos', telefono='$telefono', direccion='$direccion', email='$email', foto='$foto', password='$password', sede_fk=$sede, empresa_fk=$empresa, perfil_fk=$perfil, estado_fk=$estado, sesid='$sesid', usuario='$usuario'";
