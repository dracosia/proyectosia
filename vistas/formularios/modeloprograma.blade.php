...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración Modelo Programas.</h2>
            </div>
                ...
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> Modelo Programas</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Modelos</label>
                                        <div class="col-md-9">                                                                                
                                      ...
                                      <div class="form-group">
                                        <label class="col-md-3 control-label">Programas</label>
                                        <div class="col-md-9">                                                                                
                                            <select class="form-control select" data-live-search="true" id="fiprogramas">
                                            <option value="">Ninguno</option> 
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado del Programa Modelo por defecto "Activo"</span>
                                        </div>
                                    </div>
            ...
            <div class="col-md-7">
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> Modelo</h3>
                            ...
                            <div class="col-md-12">
                                    <div class="row" style="margin-bottom:15px;">
                                        ...
                                        <div class="col-md-3">                            
                                            ...
                                            <select class="form-control select" data-live-search="true" id="txtprograma">
 ...
 <script type="text/javascript">
          ...
          if( obj.status == "ok"){     
            ...
            var cadena_tabla="";
             for(i=0;i<datos_modelos.length;i++){
                ...
                cadena_tabla+='<td style="width:45% !important;">'+datos_modelos[i].modelo+'</td>';
                cadena_tabla+='<td style="width:45% !important;">'+datos_modelos[i].programa+'    </td>';
    ...
    function validacion(){
        ...
        if($("#fiprogramas").val().trim()==""){
            mostrar_mensaje("error","El campo prorgam es obligatorio ");  
            return false;
        }      
