                ...
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> Formularios</h3>
...
@section('scripts')  
 <script type="text/javascript">
    ...
    var datos_Formularios=new Object();
    ...
    function cargar_listado(){
        ...
        request.done(function(obj) { 
          ...
          if( obj.status == "ok"){     
            var i=0;          
            datos_Formularios=obj.datos;
            var cadena_tabla="";
             for(i=0;i<datos_Formularios.length;i++){
                cadena_tabla+=' <tr>';
                cadena_tabla+='<td style="width:85px;">'+datos_Formularios[i].codigo+'</td>';
                cadena_tabla+='<td style="width:35% !important;">'+datos_Formularios[i].nombre+'</td>';
                cadena_tabla+='<td style="width:35% !important;">'+datos_Formularios[i].descripcion+'    </td>';
    ...
    function visualizar(ind){
        limpiar();
        cod_seleccionado=""+datos_Formularios[ind].codigo;
        $("#ficodigo").val(""+datos_Formularios[ind].id_codigo);
        $("#finombre").val(""+datos_Formularios[ind].nombre);
        $("#fidescripcion").val(""+datos_Formularios[ind].descripcion);
        if(datos_Formularios[ind].estado_fk=="1"){
