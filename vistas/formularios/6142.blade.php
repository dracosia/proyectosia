...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 6.1.4.2<br />
				Número y descripción de los semilleros de investigación del programa en los que participan estudiantes, de acuerdo con su tipo y modalidad.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 6.1.4.2</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- Cohortes -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Nombre  del semillero de investigación</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic1" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Nombre  del semillero de investigación</span>
                                        </div>
                                    </div>
									...
									<!-- Fuente -->
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                            	<textarea class="form-control" id="fic3" rows="5"></textarea>
                                            </div>                                            
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 6.1.4.2</h3>
