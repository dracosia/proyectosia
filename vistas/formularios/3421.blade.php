...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 3.4.2.1 - Número y porcentaje de profesores del programa que han participado en los últimos cinco años en programas de desarrollo profesoral como resultado de las políticas institucionales orientadas para tal fin.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 3.4.2.1</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- Cohortes -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Nombre del Profesor</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic1" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Nombre del Profesor</span>
                                        </div>
                                    </div>

                                     <!-- No. -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Actividad que adelantó</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Actividad que adelantó</span>
                                        </div>
                                    </div>
									
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">% Docentes Formados</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic3" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">% Docentes Formados</span>
                                        </div>
                                    </div>

									<!-- Total -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Periodo Académico</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic4" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Periodo Académico</span>
                                        </div>
                                    </div>
                                     <!-- Estado -->
                                     <div class="form-group">
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 3.4.2.1</h3>
