...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 5.2.7.1<br />
				Número y porcentaje de profesores adscritos al programa que participan en redes académicas, científicas, técnicas y tecnológicas, económicas, a nivel nacional e internacional, de acuerdo con el tipo y modalidad del programa.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 5.2.7.1</h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
									...
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Tipo de Red</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Tipo de Red</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 5.2.7.1</h3>
