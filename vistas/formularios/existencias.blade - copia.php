...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Existencias</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Existencias</h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <!-- Indicadores -->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Indicador (Tipo Existencias)</label>
                                        <div class="col-md-9">                                                                                
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            <label class="check"><input type="checkbox" id="ficalificacion" checked/> Si</label>
                                            <span class="help-block">Estado de Existencia por defecto "Si"</span>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-12">                                            
                                            <textarea class="form-control" id="fifuente" rows="5"></textarea>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado de Existencias por defecto "Activo"</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Existencias</h3>
                                        ...
                                        <div class="col-md-3">                            
											...
											<select class="form-control select" data-live-search="true" id="txtindicadores">
												<option value="">Indicadores</option> 
												 ...
												 @if($indicador->tipo_indicador_fk==6)
 ...
 <script type="text/javascript">
          ...
          if( obj.status == "ok"){     
            ...
            var cadena_tabla="";
             for(i=0;i<datos_modelos.length;i++){
                ...
                cadena_tabla+='<td style="width:20% !important;">'+datos_modelos[i].calificacion+'    </td>';
    ...
    function visualizar(ind){
       // limpiar();
        ...
        //$('#ficalificacion').val(""+datos_modelos[ind].calificacion);
		$('#fifuente').val(""+datos_modelos[ind].fuente);
       // buscar_entrevistas('visualizar');

        if(datos_modelos[ind].calificacion=="10"){
            $("#ficalificacion").prop("checked",true);
        }else{
            $("#ficalificacion").prop("checked",false);
        }
    ...
    function validacion(){
        ...
        if($("#fifuente").val().trim()==""){
            mostrar_mensaje("error","El campo fuente es obligatorio ");  
            return false;
        }  
