...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Video Tutoriales.</h2>
            </div>
                ...
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> Video Tutoriales</h3>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <!-- Código -->
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Código del Video</span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Nombre del Video</span>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Descripción del Video</span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado del video por defecto "Activo"</span>
                                        </div>
                                    </div>
            ...
            <div class="col-md-7">
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> Video Tutoriales</h3>
