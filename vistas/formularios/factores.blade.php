...
@section('contenido')   
        <div class="row">
                ...
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> Factores</h3>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <!-- Código -->
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Código del Factor</span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Nombre del Factor</span>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Descripción del Factor</span>
                                        </div>
                                    </div>
            ...
            <div class="col-md-7">
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> Factores</h3>
