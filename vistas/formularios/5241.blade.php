...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 5.2.4.1<br />
				Número de profesores o expertos nacionales o extranjeros que ha recibido el programa en los últimos cinco años (objetivos, duración y resultados de su estadía).</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 5.2.4.1</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- No. -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Objetivos de la visita</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Objetivos de la visita</span>
                                        </div>
                                    </div>
									...
									<!-- Total -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Resultados</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic4" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Resultados</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 5.2.4.1</h3>
