...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 5.1.5.2<br />
				Número y porcentaje de estudiantes del programa con participación activa en redes u organismos nacionales de la que se hayan derivado productos concretos como publicaciones en coautoría cofinanciación de proyectos, registros y patentes, entre otros.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 5.1.5.2</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- Cohortes -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Estudiante</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic1" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Estudiante</span>
                                        </div>
                                    </div>
									...
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Red u organismo nacional</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Red u organismo nacional</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 5.1.5.2</h3>
                               ...
                               <table class="table" id="tabla_generica">
                                    <thead>
                                        <tr>
											...
											<th>Indicador</th>
											<th>Estudiante</th>
                                            <th>Red u organismo nacional</th>
                                            <th>%</th>
											<th></th>
											<th></th>
											<th></th>
