                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <!-- Modelos -->
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                
                                            <select class="form-control select" data-live-search="true" id="fimodelo" onchange="buscar_indicadores('')">
                                            <option value="">Ninguno</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Indicadores -->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Indicador (Tipo Talleres)</label>
                                        <div class="col-md-9">                                                                                
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado de Talleres por defecto "Activo"</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">                            
											...
											<select class="form-control select" data-live-search="true" id="txtindicadores">
												<option value="">Indicadores</option> 
												 ...
												 @if($indicador->tipo_indicador_fk==3)
