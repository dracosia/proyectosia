                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                
											...
											<option value="">Ninguno</option> 
                                             @foreach ($arra_programas as $programas) 
                                                <option value="{{$programas->codigo}}">{{$programas->nombre}}</option>                                                
                                              @endforeach
                                            </select>
                                        </div>
                                    </div>
...
@section('scripts')  
 <script type="text/javascript">
          ...
          if( obj.status == "ok"){     
            ...
            var cadena_tabla="";
             for(i=0;i<datos_usuarios.length;i++){
				...
				cadena_tabla+='<td style="width:25% !important;">'+datos_usuarios[i].programa+'    </td>';
    ...
    function visualizar(ind){
		...
		$('#fiprogramas').selectpicker('val', ""+datos_usuarios[ind].programa_fk);
    ...
    function validacion(){
        ...
        if($("#fiprogramas").val().trim()==""){
            mostrar_mensaje("error","El campo programa es obligatorio ");  
            return false;
        } 
        if($("#fisesid").val().trim()==""){
