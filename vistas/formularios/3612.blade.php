...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 3.6.1.2<br />
				Porcentaje de estudiantes del programa que han utilizado los materiales de apoyo docente elaborado en los últimos cinco años por parte de los docentes del programa, pertinentes a la naturaleza y metodología del programa y su función pedagógica.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 3.6.1.2</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- Cohortes -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Título del material</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic1" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Título del material</span>
                                        </div>
                                    </div>
									...
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Semestre que ha utilizado el material de apoyo</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Semestre que ha utilizado el material de apoyo</span>
                                        </div>
                                    </div>
									
																		<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Total de estudiantes del semestre que han utilizado el material de apoyo</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic3" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Total de estudiantes del semestre que han utilizado el material de apoyo</span>
                                        </div>
                                    </div>

									<!-- Fuente -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Fuente</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                            	<textarea class="form-control" id="fic5" rows="5"></textarea>
                                            </div>                                            
                                            <span class="help-block">Fuente</span>
                                        </div>
                                    </div>
                                     <!-- Estado -->
                                     <div class="form-group">
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 3.6.1.2</h3>
