...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 3.2.3.1</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 3.2.3.1</h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- No. -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">No. Auxiliar</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
												<input type="radio" name="fic1" value="1"> Auxiliar<br>
												<input type="radio" name="fic1" value="2"> Asistente<br>
												<input type="radio" name="fic1" value="3"> Asociado<br>
												<input type="radio" name="fic1" value="4"> Titular<br>
												<input type="radio" name="fic1" value="5"> Sin Escalafón<br>
								
                                            </div>                                            
                                            <span class="help-block">No. Auxiliar</span>
                                        </div>
                                    </div>
									
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">% Auxiliar</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">% Auxiliar</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 3.2.3.1</h3>
