                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <!-- Indicadores -->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Indicador (Tipo Observación)</label>
                                        <div class="col-md-9">                                                                                
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado de Observación por defecto "Activo"</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">                            
											...
											<select class="form-control select" data-live-search="true" id="txtindicadores">
												<option value="">Indicadores</option> 
												 ...
												 @if($indicador->tipo_indicador_fk==5)
