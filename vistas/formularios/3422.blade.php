...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 3.4.2.2 - Número y porcentaje de profesores del programa que han recibido apoyo a la capacitación y actualización permanente, como resultado de las políticas institucionales orientadas para tal fin.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 3.4.2.2</h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
									...
									<!-- Total -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Tipo de Apoyo recibido</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic4" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Tipo de Apoyo recibido</span>
                                        </div>
                                    </div>
                                     <!-- Estado -->
                                     <div class="form-group">
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 3.4.2.2</h3>
