                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <!-- Código -->
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Nombre del Perfil</span>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Descripción del Perfil</span>
                                        </div>
                                    </div>
									 <!-- Estamento -->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Estamentos</label>
                                        <div class="col-md-9">                                                                                
                                            <select class="form-control select" data-live-search="true" id="fiestamentos">
                            ...
                            <div class="col-md-12">
                                    <div class="row" style="margin-bottom:15px;">
                                        ...
                                        <div class="col-md-2">                            
											...
											<select class="form-control select" data-live-search="true" id="txtestamentos">
...
@section('scripts')  
 <script type="text/javascript">
    ...
    function cargar_listado(){
		...
		var estamentos=$("#txtestamentos").val();
          ...
          if( obj.status == "ok"){     
            ...
            var cadena_tabla="";
             for(i=0;i<datos_Perfiles.length;i++){
				...
				cadena_tabla+='<td style="width:25% !important;">'+datos_Perfiles[i].estamentos+'    </td>';
    ...
    function visualizar(ind){
        ...
        $('#fiestamentos').selectpicker('val', ""+datos_Perfiles[ind].estamento_fk);
    ...
    function validacion(){
		...
		if($("#fiestamentos").val().trim()==""){
        mostrar_mensaje("error","El campo estamentos es obligatorio ");  
        return false;
        }          
        return true;  
    }
    ...
    function enviar_informacion(){
        ...
        var estado="";
		var estamentos=$("#fiestamentos").val();
