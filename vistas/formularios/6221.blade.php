...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 6.2.2.1<br/>
				Cualificación de los profesores adscritos al programa con asignación de horas para el desarrollo de actividades investigativas y de innovación.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 6.2.2.1</h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Profesor</span>
                                        </div>
                                    </div>

                                     <!-- No. -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">No. Horas</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">No. Horas</span>
                                        </div>
                                    </div>
									...
									<!-- Total -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Nivel de Formación</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic5" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Nivel de Formación</span>
                                        </div>
                                    </div>
									<!-- Fuente -->
                                     <div class="form-group">
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 6.2.2.1</h3>
          ...
          if( obj.status == "ok"){     
            ...
            var cadena_tabla="";
             for(i=0;i<datos_modelos.length;i++){
				...
				cadena_tabla+='<td style="width:20% !important;">'+datos_modelos[i].c6+'    </td>';
