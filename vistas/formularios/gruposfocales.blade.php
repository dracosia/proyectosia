...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Grupos Focales</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Grupos Focales</h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <!-- Indicadores -->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Indicador (Tipo Grupos Focales)</label>
                                        <div class="col-md-9">                                                                                
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="ficalificacion" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Calificación</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Grupos Focales</h3>
...
@section('scripts')  
 <script type="text/javascript">
    ...
    function validacion(){
        ...
        if($("#ficalificacion").val().trim()==""){
            mostrar_mensaje("error","El campo calificacion es obligatorio ");  
            return false;
        }      
    ...
    function enviar_informacion(){
       ...
       var calificacion=$("#ficalificacion").val();
