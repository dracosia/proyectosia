...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 4.6.5.1<br />
				Número y título de trabajos realizados por estudiantes del programa que en los últimos cinco años, hayan  merecido premios o reconocimientos significativos por la comunidad académica nacional o internacional.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 4.6.5.1</h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-12">
									...
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Nombre del trabajo</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Nombre del trabajo</span>
                                        </div>
                                    </div>
									
																		<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Reconocimiento recibido</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic3" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Reconocimiento recibido</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 4.6.5.1</h3>
