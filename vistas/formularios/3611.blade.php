...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 3.6.1.1 - <br />Número, tipo y título del material de apoyo docente elaborado en los últimos cinco años por parte de los docentes del programa, pertinentes a la naturaleza y metodología del programa y su función pedagógica.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 3.6.1.1</h3>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Asignatura</span>
                                        </div>
                                    </div>
									...
									<!-- Fuente -->
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                            	<textarea class="form-control" id="fic6" rows="5"></textarea>
                                            </div>                                            
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 3.6.1.1</h3>
