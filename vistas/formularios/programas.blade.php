...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Programas Académicos</h2>
            </div>
                ...
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> Programas Académicos</h3>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <!-- Código -->
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Código del Programa Académico</span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            ...
                                            <span class="help-block">Nombre del Programa Académico</span>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Descripción del Programa Académico</span>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado del Programa Académico por defecto "Activo"</span>
                                        </div>
                                    </div>
            ...
            <div class="col-md-7">
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> Programas Académicos</h3>
          ...
          if( obj.status == "ok"){     
            ...
            var cadena_tabla="";
             for(i=0;i<datos_modelos.length;i++){
                ...
                cadena_tabla+='<td style="width:35% !important;">'+datos_modelos[i].nombre+'</td>';
                cadena_tabla+='<td style="width:35% !important;">'+datos_modelos[i].descripcion+'    </td>';
