                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                                                                                                                        
                                            ...
                                            <span class="help-block">Estado de entrevista por defecto "Activo"</span>
                                        </div>
                                    </div>
											...
											<select class="form-control select" data-live-search="true" id="txtindicadores">
												<option value="">Indicadores</option> 
	                                             @foreach ($arra_indicadores as $indicador) 
	                                                <option value="{{$indicador->codigo}}">{{$indicador->nombre}}</option>                                                
	                                              @endforeach
	                                            </select>
...
@section('scripts')  
 <script type="text/javascript">
    ...
    function visualizar(ind){
		...
		$('#fiindicador').selectpicker('val', ""+datos_modelos[ind].indicador_fk);
