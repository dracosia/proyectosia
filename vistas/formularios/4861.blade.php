...
@section('contenido')   
        <div class="row">
            <div style="margin-left:15px;">
                <h2>Administración de Indicador 4.8.6.1<br>
				Número y tipo de reconocimientos, hechos en los últimos cinco años por entidades gubernamentales y no gubernamentales al impacto que el programa ha ejercido en los medios locales, regionales, nacionales o internacionales.</h2>
            </div>
            ...
            <div class="col-md-4">
                <form class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Gestión</strong> de Indicador 4.8.6.1 </h3>
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- No. -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Tipo de Reconocimiento</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic2" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Tipo de Reconocimiento</span>
                                        </div>
                                    </div>
									
									<!-- % -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Tipo de Entidad</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic3" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Tipo de Entidad</span>
                                        </div>
                                    </div>

									<!-- Total -->
                                     <div class="form-group">
                                        <label class="col-md-3 control-label">Entorno</label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="fic4" class="form-control"/>
                                            </div>                                            
                                            <span class="help-block">Entorno</span>
                                        </div>
                                    </div>
             ...
             <div class="col-md-8">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong>Listado</strong> de Registros Indicador 4.8.6.1 </h3>
